...
class EllipseColorbar:
    ...
    def __init__(
        ...
        axins.set_ylim(0, height)
        axins.set_xlim(0, width)
        ...
        if title is not None:
            if title_fontproperties is None:
                title_fontproperties = {'weight': 600, 'size': 'medium'}
            axins.set_title(title, loc=title_align, fontdict=title_fontproperties)

    def __getattr__(self, item):
        getattr(self.cbar, item)
